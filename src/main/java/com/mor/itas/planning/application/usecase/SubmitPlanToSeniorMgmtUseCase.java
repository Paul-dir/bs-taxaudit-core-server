...
public class SubmitPlanToSeniorMgmtUseCase {
    ...
    public void execute(UUID planId, UUID actorId) {
        ...
        plan.finalizeByDirector(actorId);

        planRepository.save(plan);
        workflowEnginePort.startApprovalChain(plan.getId(), "ANNUAL_PLAN_SENIOR_MGMT_APPROVAL");
    }
}
